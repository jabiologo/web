...
You can find all the materials here: [slides](https://jabiologo.quarto.pub/iber_aeet) and a [full script](https://raw.githubusercontent.com/jabiologo/web/tutorials/iber_aeet.R) with the code we will use.
