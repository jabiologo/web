...
```{r malthus, echo=F, fig.height = 5.8, fig.width = 6, fig.align = "center"}
# Parámetros
N0 <- 10
r  <- 0.3
# Tiempos
...
```{r verhulst, echo=F, fig.height = 5.8, fig.width = 6, fig.align = "center"}
# Parámetros
N0 <- 10
r  <- 0.1
K  <- 100
...
```{r volterra, echo=F, fig.height = 5.8, fig.width = 6, fig.align = "center"}
library(deSolve)
