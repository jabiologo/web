...
### III Meeting SIBECOL / XVII Conference  AEET. June 2025     ###
##################################################################
library(tidyverse)
library(nimble)

# ---------------------------------------------------------------------------------------------------------------------
# Roe deer dropping count data
datos <- read.csv("https://raw.githubusercontent.com/jabiologo/web/master/tutorials/roe_deer.csv")
str(datos)
head(datos)
