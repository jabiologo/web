...
<h1 id="hero-title">Understanding wildlife.<br><em>Connecting the data.</em></h1>
<p class="hero-summary">I'm Javier Fernández-López. I work at the intersection of statistical ecology, spatial modelling and wildlife conservation.</p>
...
<div class="hero-portrait"><img src="images/javi_circulo.png" alt="Javier Fernández-López" width="409" height="308"><p>Javier Fernández-López<span>Researcher in statistical & spatial ecology</span></p></div>
</section>
...
```{=html}
<div class="contact-panel"><div><p class="eyebrow">Get in touch</p><h2>Let's connect.</h2></div><a href="mailto:jflopez.bio@gmail.com">jflopez.bio@gmail.com <span aria-hidden="true">↗</span></a><a href="https://twitter.com/javi_ferlop">Twitter / X <span aria-hidden="true">↗</span></a></div>
```
